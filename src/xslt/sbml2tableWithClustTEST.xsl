...
<xsl:stylesheet version="1.0" 
  ...
  <!-- id with notes -->
    ...
    <xsl:template match="*[local-name()='listOfFunctionDefinitions']" mode="table">
      ...
      <div id="scrollAreaFincDef" class="clusterize-scroll">
        <tbody id="contentAreaFincDef" class="clusterize-content">
    ...
    <xsl:template match="*[local-name()='listOfUnitDefinitions']" mode="table">
      ...
      <xsl:apply-templates select="*[local-name()='annotation']" mode="element"/>
      <div class="clusterize">
      <table class="w3-table w3-striped w3-border w3-hoverable w3-card-4 clusterize" style="width: auto;max-width:95%;">
      <div id="scrollAreaUnitDef" class="clusterize-scroll">
        <tbody id="contentAreaUnitDef" class="clusterize-content">
          <tr class="w3-blue-grey">
            <th>id</th>
            <th><xsl:if test="*/@name">name</xsl:if></th>
            <th><xsl:if test="*/@metaid">metaid</xsl:if></th>
    ...
    <xsl:template match="*[local-name()='listOfCompartmentTypes']" mode="table">
      ...
      <div class="clusterize">
      <table class="w3-table w3-striped w3-border w3-hoverable w3-card-4" style="width: auto;max-width:95%;">
      <div id="scrollAreaCompType" class="clusterize-scroll">
        <tbody id="contentAreaCompType" class="clusterize-content">
    ...
    <xsl:template match="*[local-name()='listOfSpeciesTypes']" mode="table">
      ...
      <div class="clusterize">
      <table class="w3-table w3-striped w3-border w3-hoverable w3-card-4" style="width: auto;max-width:95%;">
      <div id="scrollAreaSpType" class="clusterize-scroll">
        <tbody id="contentAreaSpType" class="clusterize-content">
          <tr class="w3-blue-grey"><th>id</th><th>name</th><th>metaid</th></tr>
    ...
    <xsl:template match="*[local-name()='listOfCompartments']" mode="table">
      ...
      <div class="clusterize">
      <table class="w3-table w3-striped w3-border w3-hoverable w3-card-4" style="width: auto;max-width:95%;">
      <div id="scrollAreaComp" class="clusterize-scroll">
        <tbody id="contentAreaComp" class="clusterize-content">
          <tr class="w3-blue-grey">
          <th>id</th>
          <th><xsl:if test="*/@name">name</xsl:if></th>
          <th><xsl:if test="*/@metaid">metaid</xsl:if></th>
  ...
  <xsl:template match="*[local-name()='listOfSpecies']" mode="table">
      ...
      <div class="clusterize">
      <table class="w3-table w3-striped w3-border w3-hoverable w3-card-4"  style="width: auto; max-width:95%;">
      <div id="scrollAreaSp" class="clusterize-scroll">
        <tbody id="contentAreaSp" class="clusterize-content">
          <tr class="w3-blue-grey">
          <th>id</th>
          <th><xsl:if test="*/@name">name</xsl:if></th>
          <th><xsl:if test="*/@metaid">metaid</xsl:if></th>
  ...
  <xsl:template match="*[local-name()='listOfParameters']" mode="table">
      ...
      <div class="clusterize">
      <table class="w3-table w3-striped w3-border w3-hoverable w3-card-4" style="width:auto; max-width:95%;">
      <div id="scrollAreaParam" class="clusterize-scroll">
        <tbody id="contentAreaParam" class="clusterize-content">
          <tr class="w3-blue-grey">
          <th>id</th>
          <th><xsl:if test="*/@name">name</xsl:if></th>
          <th><xsl:if test="*/@metaid">metaid</xsl:if></th>
  ...
  <xsl:template match="*[local-name()='listOfInitialAssignments']" mode="table">
      ...
      <div class="clusterize">
      <table class="w3-table w3-striped w3-border w3-hoverable w3-card-4"  style="width: auto; max-width:95%;">
      <div id="scrollAreaInAs" class="clusterize-scroll">
        <tbody id="contentAreaInAs" class="clusterize-content">
          <tr class="w3-blue-grey">
          <th>symbol</th>
          <th><xsl:if test="*/@metaid">metaid</xsl:if></th>
          <th>math:</th>
  ...
  <xsl:template match="*[local-name()='listOfConstraints']" mode="table">
      ...
      <div class="clusterize">
      <table class="w3-table w3-striped w3-border w3-hoverable w3-card-4"  style="width: auto; max-width:95%;">
      <div id="scrollAreaConst" class="clusterize-scroll">
        <tbody id="contentAreaConst" class="clusterize-content">
          <tr class="w3-blue-grey">
            <th><xsl:if test="*/@metaid">metaid</xsl:if></th>
            <th>message</th>
            <th>math:</th>
  ...
  <xsl:template match="*[local-name()='listOfRules']" mode="table">
      ...
      <div class="clusterize">
      <table class="w3-table w3-striped w3-border w3-hoverable w3-card-4"  style="width: auto; max-width:95%;">
      <div id="scrollAreaRule" class="clusterize-scroll">
        <tbody id="contentAreaRule" class="clusterize-content">
          <tr class="w3-blue-grey">
          <th>type</th>
          <th>variable</th>
          <th><xsl:if test="*/@metaid">metaid</xsl:if></th>
  ...
  <xsl:template match="*[local-name()='listOfReactions']" mode="table">
      ...
      <div class="clusterize">
      <table class="w3-table w3-striped w3-border w3-hoverable w3-card-4" style="width: auto; max-width:95%;">
      <div id="scrollAreaReact" class="clusterize-scroll">
        <tbody id="contentAreaReact" class="clusterize-content">
          <tr class="w3-blue-grey">
            <th>id</th>
            <th><xsl:if test="*/@name">name</xsl:if></th>
            <th><xsl:if test="*/@metaid">metaid</xsl:if></th>
  ...
  <xsl:template match="*[local-name()='listOfEvents']" mode="table">
      ...
      <div class="clusterize">
      <table class="w3-table w3-striped w3-border w3-hoverable w3-card-4"  style="width: auto; max-width:95%;">
      <div id="scrollAreaEvents" class="clusterize-scroll">
        <tbody id="contentAreaEvents" class="clusterize-content">
          <tr class="w3-blue-grey">
            <th>id</th>
            <th><xsl:if test="*/@name">name</xsl:if></th>
            <th><xsl:if test="*/@metaid">metaid</xsl:if></th>
