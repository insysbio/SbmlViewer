const superexample_l2v4Text = require('../cases/superexample-l2v4.xml');
...
const superexample_l3v1Text = require('../cases/superexample-l3v1.xml');

module.exports = function(parser){
  return {
    superexample_l2v4: parser.parseFromString(superexample_l2v4Text, 'application/xml'),
    ...
    superexample_l3v1: parser.parseFromString(superexample_l3v1Text, 'application/xml'),
